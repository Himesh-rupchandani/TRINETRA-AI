...
const SEEDS: Seed[] = [
  ...
  ['CAM06', 'Gujarat University Junction', 23.0395, 72.545, 'Traffic Police', 'West', 'DEGRADED', 'H265', 1280, 720, 15, 'WEBRTC'],
  ...
  ['CAM10', 'Jamalpur Gate', 23.013, 72.582, 'Police', 'Central', 'OFFLINE', 'H264', 1280, 720, 20, 'WEBRTC'],
  ...
  ['CAM15', 'Vatva GIDC Gate', 22.96, 72.63, 'Industrial Security', 'South', 'DEGRADED', 'H264', 1280, 720, 12, 'WEBRTC'],
  ...
  ['CAM28', 'Iskcon Cross Roads', 23.027, 72.507, 'Traffic Police', 'West', 'ONLINE', 'H264', 2560, 1440, 30, 'WEBRTC'],
  ['CAM29', 'S.G. Highway Bopal', 23.03, 72.47, 'Highway Authority', 'West', 'ONLINE', 'H264', 2560, 1440, 30, 'WEBRTC'],
  ['CAM30', 'Sarkhej Circle', 22.98, 72.5, 'Highway Authority', 'West', 'ONLINE', 'H264', 1920, 1080, 25, 'WEBRTC'],
].map(
  (r) =>
    ({
      name: r[0],
