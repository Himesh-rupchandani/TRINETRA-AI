...
All captured from the running app in the light Government Operations theme, except the camera-detail
...
grid drops to 1–2 columns, tables scroll horizontally. **Light Government Operations theme (Public Sans + IBM Plex Mono, institutional green accent) is the
